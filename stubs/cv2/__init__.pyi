...
def polylines(img: Mat, pts: typing.List[NDArray[np.generic]], isClosed: bool, color: typing.Tuple[int, int, int], thickness: int = ..., lineType: int = ..., shift: int = ...) -> Mat: ...
def putText(img: Mat, text: str, org: NDArray[np.generic], fontFace: int, fontScale: float, color: typing.Tuple[int, int, int], thickness: int = ..., lineType: int = ..., bottomLeftOrigin: bool = ...) -> Mat: ...
...
def flip(img: Mat, code: int) -> Mat: ...
def resize(img: Mat, size: typing.Tuple[int, int]) -> Mat: ...
def drawFrameAxes(image: Mat, cameraMatrix: Any, distCoeffs: Any, rvec: Any, tvec: Any, length: float) -> None: ...
...
class VideoWriter:
    def __init__(self, filename: str, fourcc: int, fps: float, frameSize: typing.Tuple[int, int]) -> None: ...
